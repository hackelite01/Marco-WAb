...
PS: If you don't want to use your email, go to https://temp-mail.org/en/ and generate a temporary disposable email address lol)/
...
```mongodb+srv://MayankRajput:hackelite01@cluster0.v93qb.mongodb.net/MarcoUserbot?retryWrites=true&w=majority```
 ##### Don't use this example URI cause it's only for example >_<
